...
export const ROW_BG_COLORS: Record<string, string> = {
  emergency: 'rgba(229, 57, 53, 0.18)',
  alert:     'rgba(234, 88, 12, 0.16)',
  critical:  'rgba(244, 81, 30, 0.16)',
...
export const ROW_BG_COLORS_DARK: Record<string, string> = {
  emergency: 'rgba(224, 112, 112, 0.22)',
  alert:     'rgba(234, 88, 12, 0.18)',
  critical:  'rgba(220, 96, 48, 0.18)',
  error:     'rgba(217, 92, 92, 0.16)',
  warning:   'rgba(212, 148, 74, 0.14)',
  notice:    'transparent',
  info:      'transparent',
  debug:     'transparent',
  ok:        'transparent',
